package com.example.mystore.model.view.productViews;
...
import com.example.mystore.model.entity.enums.ConditionEnum;
...
public abstract class BaseProductViewModel {
    ...
    public void setProductIsFavorInCurrentUser(boolean productIsFavorInCurrentUser) {
