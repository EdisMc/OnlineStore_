...
import com.example.mystore.model.binding.PasswordChangingBindingModel;
...
public class UserProfileController {
    ...
    @GetMapping("/profile")
    public String myProfile(@AuthenticationPrincipal ShopUserDetails sellAndBuyUser, Model model){
    ...
    public String editUserInfo(@AuthenticationPrincipal ShopUserDetails sellAndBuyUser, Model model){
